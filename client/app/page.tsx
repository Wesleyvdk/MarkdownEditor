...
import { Sidebar } from './components/app-sidebar' // Reverted import
...
export default function HomePage() {
  ...
  console.log('Passing props to AppSidebar:', {
    onCreateNote: typeof handleCreateNote,
    onViewNotes: 'function', // This is an inline arrow function
    onDashboard: typeof handleBackToDashboard
  });
      ...
      <div className="flex">
        ...
        <div className="w-64 border-r border-border">
          <Sidebar
            ...
            user={{ userId: '1', email: 'test@test.com', username: 'testuser' }}
          />
        </div>
...
return (
  <div className="min-h-screen bg-background">
    <div className="flex">
      {/* Sidebar */}
      <div className="w-64 border-r border-border">
        <AppSidebar // Use the new sidebar
          onCreateNote={handleCreateNote}
          onViewNotes={() => setAppState(prev => ({ ...prev, currentView: 'notes-list' }))}
          onDashboard={handleBackToDashboard}
        />
